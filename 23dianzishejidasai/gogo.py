...
while True:
    ...
    for r in img.find_rects(threshold=100000):
        ...
        for target_x, target_y in target_points:
            ...
            FH = bytearray([0x2C,0x12,int(rect_corners[0][0]+128),int(rect_corners[0][1]+128),int(rect_corners[1][0]+128),int(rect_corners[1][1]+128),int(rect_corners[2][0]+128),int(rect_corners[2][1]+128),int(rect_corners[3][0]+128),int(rect_corners[3][1]+128),int(move_x_output+128),int(move_h_output+128),0x5B])
            uart.write(FH)
